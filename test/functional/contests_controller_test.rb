...
class ContestsControllerTest < ActionController::TestCase
  ...
  test "should create contest" do
    assert_difference('Contest.count') do
      post :create, contest: { description: @contest.description, endTime: @contest.endTime, startTime: @contest.startTime, title: @contest.title }
    end
  ...
  test "should update contest" do
    put :update, id: @contest, contest: { description: @contest.description, endTime: @contest.endTime, startTime: @contest.startTime, title: @contest.title }
    assert_redirected_to contest_path(assigns(:contest))
  end
